...
class TreeInterpolationSequence:
    ...
    def total_interpolated_trees(self) -> int:
        ...
        from the lattice-based active-changing split processing.
    ...
    def total_interpolation_steps(self) -> int:
        ...
        This property sums all interpolation work done across all pairs.
    ...
    def get_classical_interpolation_indices(self) -> list[int]:
        ...
        The current strict interpolation path does not emit separately labelled
        fallback frames.
