...
def handle_uploaded_file(
    ...
    processor = TreeProcessor(trees=trees, enable_rooting=enable_rooting)
    processed_data: InterpolationSequence = processor.interpolate_trees(trees=trees)
